...
|--------------------|---------------------|----------------------|
| **Réel: Stress Élevé**  | 71 (VP) | 109 (FN) |
| **Réel: Stress Faible** | 177 (FP) | 163 (VN) |
...
|----------|--------|---------|----------------|
| **Accuracy** | 45.00% | (VP + VN) / Total | Proportion de prédictions correctes |
| **Précision** | 28.63% | VP / (VP + FP) | Fiabilité des prédictions positives |
| **Rappel** | 39.44% | VP / (VP + FN) | Capacité à détecter les vrais positifs |
| **F1-Score** | 33.18% | 2 × (Précision × Rappel) / (Précision + Rappel) | Moyenne harmonique précision/rappel |
