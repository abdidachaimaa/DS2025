...
| **Réel: Stress Faible** | 161 (FP) | 179 (VN) |
...
|----------|--------|---------|----------------|
| **Accuracy** | 52.31% | (VP + VN) / Total | Proportion de prédictions correctes |
| **Précision** | 36.61% | VP / (VP + FP) | Fiabilité des prédictions positives |
| **Rappel** | 51.67% | VP / (VP + FN) | Capacité à détecter les vrais positifs |
| **F1-Score** | 42.86% | 2 × (Précision × Rappel) / (Précision + Rappel) | Moyenne harmonique précision/rappel |
